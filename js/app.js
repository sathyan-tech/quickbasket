...
// Boot is handled by window.load in index.html after all scripts loaded
// Stubs for firebase functions (overwritten by firebase.js)
if (!window.logComparison)        window.logComparison        = function() {};
if (!window.saveBasketToFirebase) window.saveBasketToFirebase = function() { showToast('Firebase loading…',''); };
